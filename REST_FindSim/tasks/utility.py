...
# Atfer running tasks, return this to front-end/client
class FindSimResult():
...
def parse_output(output = str, error = str, output_type = str):
    ...
    or (output_type == 'Experiment' and re.search('\[Figure\]', output) == None):
